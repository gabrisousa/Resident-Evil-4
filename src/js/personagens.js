...
//imagens separate ways

let imageSeparate = document.querySelectorAll(".imagem-separate1");
...
let imagemSeparate = document.querySelector(".imagem-separate1");



function fotoS1 (endereco) {
